...
#ifndef MACHINE_LEARNING_PROGRAMMING_EXERCISE_1_EX1_GRADIENT_DESCENT_H_
#define MACHINE_LEARNING_PROGRAMMING_EXERCISE_1_EX1_GRADIENT_DESCENT_H_
...
class GradientDescent
{
 public:
  ...
  double ComputeCost(const Data &data);
  ...
  int RunGradientDescent(const Data &data);
...
#endif	// MACHINE_LEARNING_PROGRAMMING_EXERCISE_1_EX1_GRADIENT_DESCENT_H_
