...
// Uses low-storage BFGS algorithm for optimization.
int MultiClassRegularizedLogisticRegression::OneVsAll(DataMulti &data_multi) {
  ...
  for (int class_index=1; class_index<=kNumLabels; class_index++)
  {
...
// MultiClassRegularizedLogisticRegression and DataMulti along with class 
// label.
